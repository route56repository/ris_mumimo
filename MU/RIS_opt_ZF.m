function [coef_diag,it] = RIS_opt_ZF(varargin)
%[coef_diag,it] = RIS_OPT_ZF(varargin): Iterative algorithm 1 for ZF 
% and RIS elements optimization. Returns the diagonal matrix with the
% optimized coefficients and number of iterations needed.
% INPUT PARAMETERS:
